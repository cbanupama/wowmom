...
class PostAPIController extends AppBaseController
{
    ...
    public function filterBySuperCategory($id)
    {
        $superCategory = SuperCategory::findOrFail($id);
        $data = [];
        $data['languages'] = $superCategory->languages->toArray();
        $data['interests'] = $superCategory->interests->toArray();
        $data['tags'] = $superCategory->tags->toArray();
        $data['food_categories'] = $superCategory->foodCategories->toArray();
